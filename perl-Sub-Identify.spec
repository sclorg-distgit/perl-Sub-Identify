%{?scl:%scl_package perl-Sub-Identify}
...
Name:		%{?scl_prefix}perl-Sub-Identify
Version:	0.14
Release:	12%{?dist}
...
%{?scl:scl enable %{scl} '}perl -MConfig -pi -e %{?scl:'"}'%{?scl:"'}s|^#!perl|$Config{startperl}|%{?scl:'"}'%{?scl:"'} t/*%{?scl:'}
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.14-12
- SCL
